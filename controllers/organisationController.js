...
module.exports.addSessions = (event_obj_id, names, locations, start_times, end_times, dates, types, descs) => {
    return new Promise((resolve, reject) => {
        /*if (typeof(names) === 'string') {
        ...
        SessionTransactions.addASingleSession(event_obj_id, names, locations, dates, start_times, end_times, types, descs, (err, savedSession) => {
            if (err) {
                console.log(err);
                reject({success: false, message: "An error occurred"});
            } else {
